...
public class SimpleController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ObservableList<String> items = FXCollections.observableArrayList("Buena", "Normal", "Mala");
    ...
    private void mostrarResultado() {
        try {
            ...
            mensaje.append("Experiencia: ").append(comboBox1.getValue()).append("\n"); //Podemos usar el metodo //append


            if (radioButtonParticular.isSelected()) {
                mensaje.append("Año: Primero\n");
            } else if (radioButtonEmpresa.isSelected()) {
                mensaje.append("Año: Segundo\n");
            }


            mensaje.append("Forma de pago: ").append(choiceBox1.getValue()).append("\n");


            if (checkBox1.isSelected()) {
                mensaje.append("Estudiante de DAM\n");
            }
            if (checkBox2.isSelected()) {
                mensaje.append("Estudiante de Curso inglés\n");
            }
            if (checkBox3.isSelected()) {
                mensaje.append("Estudiante de DAW\n");
            }
