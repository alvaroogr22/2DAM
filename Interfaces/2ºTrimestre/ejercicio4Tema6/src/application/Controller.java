...
public class Controller {
    ...
    public void inicializar(String dbURL, String dbUser, String dbPassword) throws SQLException {
        ...
        //btnBorrarRegistros.setOnAction(event -> eliminarJuego());
    ...
    private void eliminarJuego() {
        ...
        // Eliminar el juego de la base de datos y actualizar la TableView
        try {
            model.deleteVideojuego(nombre);
        ...
        // Mostrar un mensaje indicando que el juego ha sido añadido
        String mensaje = "Ha borrado el juego: "+ nombre;
