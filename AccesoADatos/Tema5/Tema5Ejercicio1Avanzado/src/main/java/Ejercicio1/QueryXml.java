...
public class QueryXml {
    ...
    private static String COLLECTION = "moviles";
    
    // Nombre del recurso XML dentro de la colección
    private static String RESOURCE = "moviles.xml";
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            if(res == null) {
                ...
                String xquery = "/moviles/movil[precio < 900]"; // Consulta para encontrar productos con precio menor a 50
